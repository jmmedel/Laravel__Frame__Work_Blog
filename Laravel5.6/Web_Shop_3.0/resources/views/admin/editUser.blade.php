...
@section('title') Editing {{ $user->title }} @endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                <div class="form-group">
                                        ...
                                        <br>
                                        <input type="checkbox" class = "form-group" name="author" value=1 {{ $user->author == true ? 'checked' : ''}}>Author</input>
                                        <br>
                                        <input type="checkbox" class = "form-group" name="admin" value =1 {{ $user->admin == true ? 'checked' : ''}}>Admin
                                </div>
                        </div>
