...
<head>
  ...
  <link href="{{asset('css/main.css') }}" rel="stylesheet">
    ...
    <!-- header -->
    <header class="masthead" style="background-image: url('{{ asset('assets/img/profile.jpg') }}')">
        ...
        <!-- avatar -->
          ...
          <div class="w-full lg:w-1/2">
              <ul class="list-reset flex">
                  ...
                  <li class="text-center py-3 px-4 border-b-2 border-solid border-transparent hover:border-teal">
                      <a href="#" class="text-grey-darker no-underline hover:no-underline">
                          <div class="text-sm font-bold tracking-tight mb-1">Dislike</div>
    ...
    <!-- end container -->
      ...
      <div class="w-full lg:w-1/2 bg-white mb-4">
          ...
          <div class="p-3 text-lg font-bold border-b border-solid border-grey-light">
              <a href="#" class="text-black mr-6 no-underline hover-underline">POST</a>
